...
endpoints[OPEN_WEATHER_MAP] = function (lat, lon, language) {
...
endpoints[FORECAST] = function (lat, lon, language) {
  ...
  return "https://api.forecast.io/forecast/" + FORECAST_API_KEY + "/" + lat + "," + lon + "?units=ca&lang=" + language + "&callback=cb"
}
...
parsers[OPEN_WEATHER_MAP] = function (response) {
  return {
...
parsers[FORECAST] = function (response) {
  return {
